...
class RolesMapper
{
    ...
    {
        $data = ($data instanceof Roles) ? (array) $data : (array) $this->setObjectData($data);
        $sql = new Sql($this->adapter);
        $insert = new Insert('roles');
        $insert->values($data);
    ...
    public function getAll()
    {
        ...
        if ($result instanceof ResultInterface && $result->isQueryResult()) {
        	...
        	$resultSet->setObjectPrototype(new Roles());
